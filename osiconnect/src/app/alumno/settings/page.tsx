                    ...
                    <div className="bg-white dark:bg-zinc-900 rounded-lg shadow p-6">
                        ...
                        <div className="space-y-3">
                            <label className="flex items-center gap-2">
                                ...
                                <span className="text-sm">Notificar nuevas prácticas</span>
                            </label>
                            <label className="flex items-center gap-2">
                                <input type="checkbox" defaultChecked className="rounded" />
                                <span className="text-sm">Notificar fechas de exámenes</span>
                            </label>
                            <label className="flex items-center gap-2">
                                <input type="checkbox" defaultChecked className="rounded" />
                                <span className="text-sm">Notificar mensajes del chat</span>
                            </label>
                            <label className="flex items-center gap-2">
